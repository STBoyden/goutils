...
// provides UDP-specific function implementations.
...
// success, it will return the amount of bytes written. On failure, it will return an
// error.
...
func (utc *UDPTypedConnection[T]) ReadFrom(data *T, opts ...ReadFromOptions) (int, net.Addr, error) {
...
// NewTypedUDPSocketListener creates a new *UDPSocketListener when given only a port.
// This function assumes that the host will be local, and assigns to 0.0.0.0. On success,
